...
osg::Node* GLDebugDrawer::getSceneGraph() {
    return( _group.get() );
}
...
void GLDebugDrawer::drawLine(const btVector3& from,const btVector3& to,const btVector3& color) {
    ...
    _lnVerts->push_back( asOsgVec3( from ) );
    _lnVerts->push_back( asOsgVec3( to ) );

    osg::Vec4 c = asOsgVec4( color, 1. );
...
osgText::Text* GLDebugDrawer::initText() {
